...
<div class="section padding_layout_1">
    <div class="container">
      {!! $data->about_content ? $data->about_content : "" !!}
      ...
      <div class="row about_blog d-none">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 about_feature_img padding_right_0">
          <div class="full text_align_center"> <img class="img-responsive" src="{{ asset('assets/images/it_service/post-06.jpg') }}" alt="#" /> </div>
        </div>
      </div>
      <div class="row d-none" style="margin-top: 35px">
        <div class="col-md-8">
