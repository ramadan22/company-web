        ...
        <div class="row">
            <div id="rev_slider_4_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="classicslider1" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
                <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                    <ul>
                        @foreach($banner[0] as $row)
                            <li data-index="{{ $row->banner_id }}"
                                data-transition="zoomin"
                                data-slotamount="7"
                                data-easein="Power4.easeInOut"
                                data-easeout="Power4.easeInOut"
                                data-masterspeed="2000"
                                data-thumb="{{ $row->banner_image }}"
                                data-rotate="0"  data-saveperformance="off"
                                data-title="{{ $row->banner_title }}"
                                data-description=""
                            >
                                <img src="{{ $row->banner_image }}"
                                ...
                                <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    style="z-index: 6; white-space: nowrap;">{{ $row->banner_title }}
                                </div>
