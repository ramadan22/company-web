...
<section class="content">
    <div class="container-fluid">
        <div class="card card-default">
            <form action="{{ url('admin/news__save') }}" enctype="multipart/form-data" method="post">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="news_title" value="{{ request()->old('news_title') ?? '' }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="news_content" id="summernote" class="form-control">{{ request()->old('news_content') ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
